<template>
  <div id="app">
    ...
    <div class="example">
        ...
        <datepicker placeholder="Select Date" v-model="vModelExample" :format="'dd/MM/yyyy'" :disabled="{ to: new Date(1973, 0, 5), from: new Date() }"></datepicker>
        <code>
    ...
    <div class="example">
      <datepicker v-model="inputValueLeft"
                        :id="inputName"
                        :name="inputName"
                        class="input-no-daterange"
                        :wrapper-class="`datepicker-input ${inputValueLeft ? 'has-value' : ''}`"
                        :format="formatDate"
                        :monday-first="true"
                        language="tr"
                        ...
                        :clear-button="true"
                        clear-button-icon="glyphicon glyphicon-remove">
            </datepicker>
    </div>
